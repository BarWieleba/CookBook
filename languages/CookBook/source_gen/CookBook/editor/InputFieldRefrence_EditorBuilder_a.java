...
/*package*/ class InputFieldRefrence_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public InputFieldRefrence_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_i63n6x_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.field$iS28;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.field$iS28);
    }
